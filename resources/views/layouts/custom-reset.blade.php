...
<head>
    <meta charset="UTF-8">
    <title>Reset Password - Document Finder</title>
...
<div class="w-full max-w-md space-y-4 px-4">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <h2 class="text-md font-semibold text-center text-gray-700 mb-1">Reset Password</h2>
        <p class="text-xs text-center text-gray-500 mb-4">Enter your new password below</p>
