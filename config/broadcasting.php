...
return [
    ...
    | framework when broadcasting an event. You may set this to any of
    ...
    */
    ...
    | well as their respective settings. Laravel currently supports a variety
    | of drivers for broadcasting live events across your web application.
    |
